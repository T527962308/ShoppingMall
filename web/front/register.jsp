			...
			<div id="mr-content" class="mr-content col-xs-12">
				<div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
					...
					<div class="login">
						...
						<!-- 会员注册表单 -->
						<form id="member-registration" action="LoginServlet" method="post" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<!-- 密码文本框 -->
										<input type="password" name="password1" id="pwd" value=""
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										<!-- 邮箱文本框 -->
										<input type="email" name="addrs" class="validate-email"
											   id="jform_email2" value="" size="38" aria-required="true">
									</div>
								</div>
								<div class="form-group">
