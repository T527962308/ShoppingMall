										...
										<c:forEach items="${goodsinfo}" var="goods" varStatus="s">
												<div
													...
													<div class="product-thumb transition">
														<div class="actions">
															<div class="image">
																<a href="goodsDetail.jsp?ID=${goods.id}">
																<img src="upload/${goods.goodsinfoPic}"  width="90px" height="90px" alt=${goods.goodsinfoName} class="img-responsive"></a>
															</div>
														...
														<div class="caption">
															<div class="name" style="height: 40px">
																<a href="goodsDetail.jsp?ID=${goods.id}"> <span style="color: #0885B1">商品名：</span>${goods.goodsinfoName}</a>
															</div>
															<div class="name" style="margin-top: 10px"><p class="price">价格：${goods.goodsinfoPrice}</p></div>
														</div>
													</div>
												</div>
										</c:forEach>
